    ...
    <div id="side">
        ...
        <div id="menu">
            <div class="wrapper" dir="rtl">
                ...
                <div class="menu-item" style="float:right !important;">
                    <a href="fa/postcard.php"><i class="icon icon-postcard3"></i></a>
                    <a href="fa/postcard.php"><p><span>•&nbsp;</span>ارسال کارت‌پستال<span>&nbsp;•</span></p></a>
                </div>
                <div class="menu-item" style="float:right !important;">
                    <a href="fa/contact.php"><i class="icon icon-phone378-1"></i></a>
                    <a href="fa/contact.php"><p><span>•&nbsp;</span>ارتباط با ما<span>&nbsp;•</span></p></a>
                </div>
                <div class="menu-item" style="float:right !important;">
...
<!--            item-01 size:224*362 vertical-->
            <div class="content-item bk hvr-sweep-to-right ver" style="background-image: url(../img/a1.jpg);">
                <div class="container" dir="rtl">
                    ...
                    <br/>
                    <a href="fa/postcard.php"><i class="fa fa-paper-plane"></i></a>
                    ...
                    <a href="fa/item1-fa.php"><i class="fa fa-info-circle"></i></a>
                </div>
            </div>
...
<!--            item-add -->
            <div class="content-item bk hvr-sweep-to-right" style="background-image: url(../img/add.png);">
                <div class="container" dir="rtl" style="padding-right:8px; line-height:120%;">
                    ...
                    <br>
                    <a class="contactus" href="fa/contact.php"><p><span>•&nbsp;</span>ارتباط با ما<span>&nbsp;•</span></p></a>
                </div>
            </div>
        </div>
    </div>
